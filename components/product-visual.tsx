...
> = {
  ...
  governance: {
    title: "Agent governance · tool-using agent",
    rows: [
      { label: "Access scope", value: "CRM + email + billing", tone: "warn" },
      { label: "Allowlist", value: "Not named", tone: "bad" },
      { label: "Human oversight", value: "Missing", tone: "bad" },
      { label: "Audit trail", value: "Tool calls not traced", tone: "bad" },
      { label: "Kill switch", value: "Not named", tone: "warn" },
    ],
  },
  process: {
    title: "Workflow scan · vendor onboarding",
    rows: [
      { label: "Handoffs", value: "4 named, 1 implicit", tone: "warn" },
      { label: "Rework loop", value: "Sanctions → form", tone: "bad" },
      { label: "Decision wait", value: "2 days average", tone: "warn" },
      { label: "Automation fit", value: "Gates, not an agent", tone: "ok" },
      { label: "Leave alone", value: "Legal exception path", tone: "ok" },
    ],
  },
};
